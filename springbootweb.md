...
![image-20240215203146559](./images/image-20240215203146559.png)
...
![image-20240215231450296](./images/image-20240215231450296.png)
...
![image-20240216110014579](./images/image-20240216110014579.png)
...
![image-20240216114502991](./images/image-20240216114502991.png)
...
- 部门列表查询
  ...
  **注意：如果有多个属性，就必须指定每个属性的属性名**
  ...
  ![image-20240216221551411](./images/image-20240216221551411.png)
  ...
  ![image-20240216223324934](./images/image-20240216223324934.png)
...
- 前后端联调
  ...
  ![image-20240216224107374](./images/image-20240216224107374.png)
  
- 删除部门

  1. 先看页面原型中的需求，发现这是给前端看的，实际上后端的任务是做一个接口，根据id来删除当前部门的信息

     ![image-20240216224704908](.\images\image-20240216224704908.png)
...
- OSS
  ...
  ![image-20240217162404497](.\images\image-20240217162404497.png)
...
4. 在`AliOSSProperties`属性类中加上注解后出现了一个警告
   ...
   ![image-20240217185604064](.\images\image-20240217185604064.png)
...
![image-20240217231451110](.\images\image-20240217231451110.png)

![image-20240217231509189](.\images\image-20240217231509189.png)
...
![image-20240218111317826](.\images\image-20240218111317826.png)

检验一下：打开一个过滤器DemoFilter，使用apifox发一个查询部门请求，查看控制台信息

![image-20240218111621715](.\images\image-20240218111621715.png)

![image-20240218111654442](.\images\image-20240218111654442.png)
...
![image-20240218113041706](.\images\image-20240218113041706.png)

加上令牌再发送，控制台会输出，并执行业务操作，最后执行拦截器的`postHandle afterCompletion`

![image-20240218113127714](.\images\image-20240218113127714.png)
...
![image-20240218115821326](.\images\image-20240218115821326.png)
...
![image-20240218120318086](.\images\image-20240218120318086.png)
...
![image-20240218120538939](.\images\image-20240218120538939.png)
...
![image-20240218125558705](.\images\image-20240218125558705.png)
...
![image-20240218161725610](.\images\image-20240218161725610.png)
...
![image-20240218162829300](.\images\image-20240218162829300.png)
...
![image-20240218163322456](.\images\image-20240218163322456.png)
...
![image-20240218171101635](.\images\image-20240218171101635.png)
...
![image-20240218171917881](.\images\image-20240218171917881.png)

对insert事务的提交

![image-20240218172045947](.\images\image-20240218172045947.png)

最后一行意思是内部事务结束以后，继续运行刚才挂起的事务，即delete方法的事务，delete报错之后会正常的进行回滚操作

![image-20240218172139559](.\images\image-20240218172139559.png)
...
![image-20240218173915135](.\images\image-20240218173915135.png)
...
![image-20240218190700816](./images/image-20240218190700816.png)

点击编辑部门按钮，就会触发根据id查询部门数据操作，可以在控制台中查看方法的耗时

![image-20240218190736451](./images/image-20240218190736451.png)
...
![image-20240218191622179](.\images\image-20240218191622179.png)
...
![image-20240218193034302](.\images\image-20240218193034302.png)

打开页面点击部门管理，通过断点调试查看信息

![image-20240218193319300](.\images\image-20240218193319300.png)
...
![image-20240218193710631](.\images\image-20240218193710631.png)

当前的断点放行之后就会调用原始的目标对象（DeptServiceImpl）的`list`方法

![image-20240218193827058](.\images\image-20240218193827058.png)

继续断点放行，会回到AOP类中继续执行剩下的逻辑，最后返回结果

![image-20240218194026757](.\images\image-20240218194026757.png)
...
![image-20240218200008953](.\images\image-20240218200008953.png)

原始方法执行结束后运行了三个通知

![image-20240218200108169](.\images\image-20240218200108169.png)

afterThrowing没有执行，现在测试一下异常情况，在随便一个方法中加一句`int i = 1 / 0;`在页面中点一下编辑，看控制台的信息

![image-20240218200316462](.\images\image-20240218200316462.png)
...
![image-20240218202424031](.\images\image-20240218202424031.png)

![image-20240218202433378](.\images\image-20240218202433378.png)
...
![image-20240218213731763](.\images\image-20240218213731763.png)

![image-20240218213817983](.\images\image-20240218213817983.png)
...
![image-20240218225913445](.\images\image-20240218225913445.png)
...
![image-20240219083533788](.\images\image-20240219083533788.png)
...
![image-20240219084425900](.\images\image-20240219084425900.png)

![image-20240219084630345](.\images\image-20240219084630345.png)
...
![image-20240219084734025](.\images\image-20240219084734025.png)
...
![image-20240219085120983](.\images\image-20240219085120983.png)
...
![image-20240219114009219](.\images\image-20240219114009219.png)
...
![image-20240219114810222](.\images\image-20240219114810222.png)
...
![image-20240219145136316](.\images\image-20240219145136316.png)
...
![image-20240219151112328](.\images\image-20240219151112328.png)
...
- 方案2：通过给启动类加`@Import`注解导入。使用import导入的类会被Spring加载到IoC容器中，主要有三种方式
  ...
  **注意：`@Import`注解的参数类型是数组，所以需要用大括号括起来**
  ...
  ![image-20240219153915398](.\images\image-20240219153915398.png)
...
![image-20240219160850495](.\images\image-20240219160850495.png)
...
![image-20240219161050200](.\images\image-20240219161050200.png)

在实现类中找一下这个方法，关注这个返回值到底封装了哪些类的全类名

![image-20240219161359148](.\images\image-20240219161359148.png)
...
![image-20240219161640425](.\images\image-20240219161640425.png)
...
![image-20240219162137326](.\images\image-20240219162137326.png)
...
![image-20240219165124572](.\images\image-20240219165124572.png)

现在找到这两个jar包看看里边都有什么信息，在项目侧边栏中点开外部库，找到SpringBoot官方的`autoconfigure`

![image-20240219170030987](.\images\image-20240219170030987.png)
...
![image-20240219171320987](./images/image-20240219171320987.png)
...
![image-20240219171441364](./images/image-20240219171441364.png)
...
![image-20240219174124489](.\images\image-20240219174124489.png)
...
![image-20240219175051223](.\images\image-20240219175051223.png)

 可以看到果然报错了，提示找不到HeaderParser这样一个bean

![image-20240219175242493](./images/image-20240219175242493.png)
...
![image-20240219182737064](.\images\image-20240219182737064.png)
...
![image-20240219193918068](.\images\image-20240219193918068.png)
...
![image-20240219205931366](./images/image-20240219205931366.png)
...
![image-20240219210350298](./images/image-20240219210350298.png)
